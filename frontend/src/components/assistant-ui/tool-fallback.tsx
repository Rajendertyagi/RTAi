// Copied from official Assistant UI registry — immutable commit b6e7ab88b5e6e60866695d31a08adc3a80f449ff (pinned @assistant-ui/react@0.15.17 / @assistant-ui/core@0.3.16)
// Source: https://raw.githubusercontent.com/assistant-ui/assistant-ui/b6e7ab88b5e6e60866695d31a08adc3a80f449ff/packages/ui/src/components/assistant-ui/tool-fallback.tsx
// Registry documentation: https://www.assistant-ui.com/elements/tool-fallback
// Verified: file exists at pinned commit (200), identical to main's tool-fallback.aui.tsx; contains ToolFallback, ToolFallbackApproval with approval.options/optionId/resolution and respondToApproval.
// Compatibility: ToolCallMessagePart approval fields present in pinned core@0.3.16 (types/message.ts:228-237), useScrollLock/useToolCallElapsed present in react@0.15.17; Button/Collapsible/cn deps audited below.
// Preserves attribution/header conventions found in the official registry source.
// Verified: ToolCallMessagePart approval fields (approval.id/approved/options/optionId/resolution) and respondToApproval are present in pinned core@0.3.16 (packages/core/src/types/message.ts:228-237) and react@0.15.17 re-exports.
"use client";
