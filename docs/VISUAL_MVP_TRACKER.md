...
| 2 | Application shell | h-dvh shell, flex shrink chain, header h-12 (48px), fluid sidebar column + mobile drawer at 768px, scroll ownership, shared 48rem content column, inert closed drawer, 44px mobile touch targets. Exact formulas live in FRONTEND_UI_SPEC.md section 1 | Implemented in source | HEAD | pending | pending | CI build verification; browser verification at 320/375/768/1024/1280/1440/1920/2560px |
| 2B | Application Shell 1B — resizable desktop sidebar (280-500px, persisted and keyboard accessible) | Drag handle on the docked desktop sidebar; pointer capture; localStorage persistence; keyboard-accessible separator semantics | Planned | — | — | — | Specify in FRONTEND_UI_SPEC.md section 1 before coding; implement only after the base shell passes browser verification; resolve the default-width vs 280px minimum conflict (fluid clamp yields < 280px below a 1556px viewport) |
